...
def migrate_main():
    ...
    for ynab4_account in thisynab.accounts:
        ...
        mindate = min([ynab4transaction.date for ynab4transaction in thisynab.transactions if
                       ynab4transaction.account == ynab4_account])
    ...
    for ynab4_payee in thisynab.payees:
        ...
        #
        #     split_id = next(x.id for x in nYNABobject.budget.be_subcategories
        # if x.internal_name == 'Category/__Split__')
        #
        ...
        #                 try:
        #                     payee_id = payeemapping[next(x.PayeeName for x in accumulatedSplits
        ...
        # = submapping[split.MasterCategoryName][split.SubcategoryName]
        #                         subtransactions.append(Subtransaction(
        #                             amount=split.Inflow - split.Outflow,
        #                             date=split.Date,
        #                             entities_account_id=accountmapping[split.AccountName],
        ...
        #                 else:
        #                     entities_subcategory_id
        # = submapping[register_row.MasterCategoryName][register_row.SubcategoryName]
        #                 transactions.append(Transaction(
        #                     amount=register_row.Inflow - register_row.Outflow,
        #                     date=register_row.Date,
        #                     entities_account_id=accountmapping[register_row.AccountName],
        ...
        #                 ))
        #
        #     unsplittransactions=[transaction for transaction in transactions
        # if transaction.entities_subcategory_id != split_id]
        #     splittransactions=[transaction for transaction in transactions
        # if transaction.entities_subcategory_id == split_id]
        #
        ...
        #                             and tr1.amount == -tr2.amount:
        #                         siblings = [subtransaction for subtransaction in subtransactions
        # if subtransaction.entities_transaction_id == tr2parent.id]
        #
        ...
        #                             and tr1.amount == -tr2.amount:
        #                         siblings = [subtransaction for subtransaction in subtransactions
        # if subtransaction.entities_transaction_id == tr1parent.id]
        #
        #                         tr1.transfer_transaction_id = tr2.id
